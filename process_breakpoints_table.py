...
#                 if com_anc.name in ancs and len(parents[com_anc.name]) == \
#                    len(oc):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--filter_num', help='filter rows containg number of '
                        'breakpoints')
#     parser.add_argument('--search_tree', help='filter newick tree')
#     parser.add_argument('--key_ancs', nargs='+', help='list of ancestral '
#                         'genomes')
